...
const Cart = () => {
    ...
    <div>
  {
    cart.length > 0 ?
    (
      <div className="grid grid-cols-2 mt-28 ml-16 cart">
    <div className="">
       {
        cart.map((item,index) =>(
       ...
       <div className=" fixed right-24 summary price">
        <div className="flex flex-col gap-5 w-[30vw]  mt-4 border-2 h-fit p-5 shadow-lg min-w-[350px]">
    ...
    </div>):(<div className="h-[80vh] w-full flex flex-col  items-center gap-3 mt-32">
    <img src="../assets/cart.png" width={400}/ >
    <h1 className="text-2xl font-semibold"> Your Cart is empty !</h1>
    <div className="text-gray-400 text-xl flex justify-center px-10 w-[100%]">Explore our wide selection and find something you like</div>
    <NavLink to="/">
