...
const Product = ({post}) => {
  ...
  return (
    <div className="flex flex-col items-center shadow-md justify-between hover:scale-110 transition duration-300 ease-in hover:shadow-2xl rounded-lg p-3 w-[220px]">
       <div>
