...
const Navbar = (props) => {
  ...
  return (
    ...
    <div className="flex justify-center bg-slate-900 text-xl p-2 fixed top-0 w-[100vw] z-10">
      <div className="flex justify-between w-[65vw] flex-wrap bg-slate-900">
        <NavLink to="/">
          <img src="../assets/logo.png" className="h-14" />
        </NavLink>
        <div className="text-[white] flex  items-center gap-10 nav">
