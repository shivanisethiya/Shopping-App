...
const LoginForm = ({setLogin}) => {
  ...
  return (
    <div className="gap-40 flex justify-evenly  mt-40 flex-wrap-reverse ">
      ...
      className=" p-10 mt-7 w-[30vw] shadow-md shadow-gray-500 min-w-[350px]">
        <label>
...
<div className="flex justify-end mt-2">
      ...
      <img src="../assets/login.webp" width={480} height={300} className="rounded-lg shadow-lg hello"></img>
    </div>
  );
};
